...
namespace Warehouse.storage1
{
    internal class AuthRepoImpl : AuthRepo
    {
        ...
        {
            string query = $"INSERT INTO _user(username, password, role, creation_date) VALUES('{userEntity.username}', '{userEntity.password}', '{userEntity.role}', '{DateTime.Today.ToString("yyyy-MM-dd")}')";
